...
const AddEmpFM = () => {
  ...
  const handleEmpFMSubmit = async (e) => {
    e.preventDefault();
    ...
    const payload = {
      ...
      foreign_mission_id: formData.foreign_mission_id 
        ? Number(formData.foreign_mission_id) 
        : null,
      foreign_mission_date: formData.foreign_mission_date,
    };

    try {
      await axios.post("http://localhost:3000/employee_foreign_mission", payload);
  ...
  return (
    <div className="add-employee-page px-5 mt-4">
      <div className="table-responsive p-4 mb-4">
        <>
          <form onSubmit={handleEmpFMSubmit}>
